  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
        <button
          onClick={() => navigate("/")}
          className="flex items-center gap-2 text-gray-500 hover:text-primary-500 transition-colors mb-8 group"
        >
          ...
          <div className="card p-6 sm:p-8 space-y-6">
            <section>
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                En ShareNotes, nos tomamos muy en serio tu privacidad. Esta política describe
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-3">
                Uso de Google Services
              </h2>
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                Esta aplicación utiliza <strong>Google Docs</strong> para guardar tus notas
                y <strong>Gmail</strong> para enviarlas cuando así lo solicites. Solo
                accedemos a estos servicios con tu permiso explícito y únicamente para las
                funcionalidades que tú activas.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                Tus datos no son compartidos con terceros. La información que publicas
                como nota pública es visible para otros usuarios dentro de la plataforma,
                pero nunca vendemos ni cedemos tus datos personales a terceros.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                Tus datos están protegidos mediante autenticación JWT, cookies seguras
                y cifrado en tránsito (HTTPS). Implementamos las mejores prácticas de
