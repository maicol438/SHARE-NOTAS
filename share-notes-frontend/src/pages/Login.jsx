...
import { Mail, Lock, BookOpen, Eye, EyeOff, ArrowLeft } from "lucide-react";
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="card p-8 shadow-2xl">
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            <div className="flex flex-col gap-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`input-field pl-10 ${errors.email ? "border-red-500 ring-2 ring-red-500" : ""}`}
                  autoComplete="email"
                />
              </div>
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  placeholder="••••••••"
                  className={`input-field pl-10 pr-12 ${errors.password ? "border-red-500 ring-2 ring-red-500" : ""}`}
            ...
            <Button type="submit" isLoading={isLoading} className="w-full mt-2 py-3 text-lg rounded-xl">
              Ingresar
            </Button>
