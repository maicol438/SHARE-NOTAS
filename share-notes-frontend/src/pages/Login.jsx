...
const LoadingScreen = () => (
  <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-500/20 via-purple-500/10 to-pink-500/20 dark:from-primary-950/30 dark:via-purple-950/20 dark:to-pink-950/20">
        ...
        <div className="relative">
          ...
          <div className="relative bg-white/80 dark:bg-dark-900/80 backdrop-blur-2xl border border-white/60 dark:border-white/[0.06] rounded-3xl shadow-2xl shadow-primary-500/[0.08] dark:shadow-primary-500/[0.04] p-8 md:p-9">
            ...
            <div className="flex flex-col items-center gap-1.5 mb-8 animate-slide-up delay-200">
              <h1 className="text-2xl md:text-3xl font-extrabold gradient-text">Bienvenido</h1>
              <p className="text-gray-500 dark:text-dark-400 font-medium text-sm">Ingresa a tu cuenta para continuar</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4" noValidate>
              ...
              {/* Password */}
               <div className="relative group animate-slide-up delay-400">
              ...
              <div className="flex justify-end animate-slide-up delay-500">
                <button
                  ...
                  className="text-xs font-semibold text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 hover:underline decoration-primary-400/50 underline-offset-2 transition-all"
                >
              ...
              <Button
                type="submit"
                isLoading={isLoading}
                className="w-full py-3.5 text-base rounded-xl shadow-lg shadow-primary-500/25 dark:shadow-primary-500/10 hover:shadow-xl hover:shadow-primary-500/30 dark:hover:shadow-primary-500/15 transition-all duration-200 animate-slide-up delay-500"
              >
                Ingresar
              </Button>
              ...
              {googleEnabled && (
                <>
                  <div className="relative my-4 animate-slide-up delay-600">
            ...
            {/* Sign up link */}
            <p className="text-center text-sm text-gray-500 dark:text-dark-400 mt-6 font-medium animate-slide-up delay-700">
              ¿No tienes cuenta?{" "}
              <Link
                to="/register"
