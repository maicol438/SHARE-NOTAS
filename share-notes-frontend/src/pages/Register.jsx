    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-gray-50 dark:bg-gray-950 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="flex flex-col items-center gap-3 mb-8">
          <div className="w-16 h-16 bg-gradient-to-br from-primary-500 to-purple-600 rounded-2xl flex items-center justify-center shadow-2xl shadow-primary-500/30">
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`input-field pl-10 ${errors.name ? "border-red-500 ring-2 ring-red-500" : ""}`}
                  autoComplete="name"
                />
              </div>
