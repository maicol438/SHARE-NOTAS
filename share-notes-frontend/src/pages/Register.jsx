...
import { Mail, Lock, User, BookOpen, Eye, EyeOff, ArrowLeft, Sparkles, LogOut } from "lucide-react";
    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-primary-50 via-gray-50 to-gray-50 dark:from-dark-950 dark:via-dark-900 dark:to-dark-950 relative overflow-hidden animate-fade-in">
      ...
      <div className="w-full max-w-md relative z-10 animate-slide-up">
        <div className="flex flex-col items-center gap-3 mb-8">
          ...
          <p className="text-gray-500 dark:text-dark-400">Únete a la comunidad y organiza tus notas</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5" noValidate>
            <div className="relative">
              ...
              <input
                ...
                placeholder=" "
                className={`peer input-field-floating pl-10 ${errors.name ? "border-red-400 focus:ring-red-400/30" : ""}`}
                autoComplete="name"
              />
              <label htmlFor="name" className="floating-label" style={{ left: "2.5rem" }}>
                Nombre completo
              </label>
            ...
            <div className="relative">
              ...
              <input
                ...
                autoComplete="email"
              />
              <label htmlFor="reg-email" className="floating-label" style={{ left: "2.5rem" }}>
                Correo electrónico
              </label>
            ...
            <div className="relative">
              ...
              />
              <label htmlFor="reg-password" className="floating-label" style={{ left: "2.5rem" }}>
                Contraseña
              </label>
              <button
                type="button"
            ...
            {serverError && (
              <div className="p-3 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-900/30 rounded-xl flex items-center gap-2 animate-wiggle">
                ...
                <span className="text-sm text-red-600 dark:text-red-400 font-medium">{serverError}</span>
              </div>
            )}

            <Button type="submit" isLoading={isLoading} className="w-full mt-2 py-3 text-base rounded-xl">
              Crear cuenta
            </Button>
            ...
            {googleEnabled && (
              <>
                ...
                <button
                  type="button"
                  onClick={() => window.location.href = `https://share-notas.onrender.com/api/auth/google`}
        ...
        <p className="text-center text-sm text-gray-500 dark:text-dark-400 mt-6">
          ¿Ya tienes cuenta?{" "}
          <Link to="/login" className="text-primary-600 dark:text-primary-400 hover:underline font-semibold hover:text-primary-700 dark:hover:text-primary-300 transition-colors">
            Inicia sesión
          </Link>
        </p>
      </div>
