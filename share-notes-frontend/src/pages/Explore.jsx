    ...
    <div className="max-w-6xl mx-auto">
      ...
      {isLoading && (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {[...Array(6)].map((_, i) => <div key={i} className="bg-white dark:bg-[#0d0b1f] border border-slate-200 dark:border-white/[0.06] rounded-xl p-4 animate-pulse"><div className="h-4 bg-slate-200 dark:bg-white/[0.05] rounded w-3/4 mb-2" /><div className="h-3 bg-slate-200 dark:bg-white/[0.05] rounded" /></div>)}
        </div>
      )}
